 ...
 *
 * CLIENT -> SERVER: REGISTER : payload = Player ANSWER : payload = Integer
 * (índice da opção escolhida)
 *
 * SERVER -> CLIENT: REGISTERED : payload = Player (com id atribuído) ERROR :
 * payload = String (motivo) QUESTION : payload = QuestionMsg ROUND_END :
 * payload = RoundResult GAME_END : payload = RoundResult (pontuações finais)
...
public class Message implements Serializable {
    ...
    public static class QuestionMsg implements Serializable {
        ...
        public QuestionMsg(int questionNumber, int totalQuestions, String questionText, List<String> options, int points, int timeLimitSeconds, boolean isTeamRound) {
