...
/**
 * Regista as respostas dos jogadores para a ronda atual.
...
public class AnswerManager {
    ...
    public synchronized boolean submitAnswer(String username, int answerIndex, int factor) {
        if (answers.containsKey(username)) return false; // já respondeu
    ...
    public synchronized int size() { return answers.size(); }
